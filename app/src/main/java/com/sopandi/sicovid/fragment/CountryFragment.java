package com.sopandi.sicovid.fragment;
...
import com.sopandi.sicovid.R;
import com.sopandi.sicovid.model.CountryModel;
import com.sopandi.sicovid.viewmodel.CountryViewModel;
...
public class CountryFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        pieChart = view.findViewById(R.id.idnSummaryPie);
        CountryViewModel viewModel = new ViewModelProvider(this, new ViewModelProvider.NewInstanceFactory()).get(CountryViewModel.class);
